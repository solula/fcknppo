...
//go:generate mockgen -destination mock_test1.go -package service . IChapterRepo

//go:generate mockgen -destination mock_test2.go -package service waterfall-backend/internal/modules/services/fs/i_fs IBucketCreator
