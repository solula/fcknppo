...
// The ChapterTextFunc type is an adapter to allow the use of ordinary
// function as ChapterText mutator.
type ChapterTextFunc func(context.Context, *ent.ChapterTextMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f ChapterTextFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.ChapterTextMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.ChapterTextMutation", m)
}
...
// The SeedMigrationsFunc type is an adapter to allow the use of ordinary
// function as SeedMigrations mutator.
type SeedMigrationsFunc func(context.Context, *ent.SeedMigrationsMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SeedMigrationsFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SeedMigrationsMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SeedMigrationsMutation", m)
}
