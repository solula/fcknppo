...
type Role struct {
	config `json:"-"`
	// ID of the ent.
	ID roles.Type `json:"id,omitempty"`
	// Description holds the value of the "description" field.
	Description string `json:"description,omitempty"`
	// ReleaseDelay holds the value of the "release_delay" field.
	ReleaseDelay float64 `json:"release_delay,omitempty"`
...
func (*Role) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case role.FieldID, role.FieldDescription:
	...
	for i := range columns {
		...
		case role.FieldReleaseDelay:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				return fmt.Errorf("unexpected type %T for field release_delay", values[i])
			} else if value.Valid {
				r.ReleaseDelay = value.Float64
			}
		default:
...
func (r *Role) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("release_delay=")
	builder.WriteString(fmt.Sprintf("%v", r.ReleaseDelay))
	builder.WriteByte(')')
