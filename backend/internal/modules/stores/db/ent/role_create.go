...
func (rc *RoleCreate) SetReleaseDelay(f float64) *RoleCreate {
	rc.mutation.SetReleaseDelay(f)
	return rc
}

// SetID sets the "id" field.
func (rc *RoleCreate) SetID(r roles.Type) *RoleCreate {
	rc.mutation.SetID(r)
	return rc
}
...
func (rc *RoleCreate) AddPermissionIDs(ids ...permissions.Type) *RoleCreate {
...
func (rc *RoleCreate) check() error {
	...
	if _, ok := rc.mutation.ReleaseDelay(); !ok {
		return &ValidationError{Name: "release_delay", err: errors.New(`ent: missing required field "Role.release_delay"`)}
	}
...
func (rc *RoleCreate) sqlSave(ctx context.Context) (*Role, error) {
	...
	if _spec.ID.Value != nil {
		if id, ok := _spec.ID.Value.(roles.Type); ok {
			_node.ID = id
		} else {
...
func (rc *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if value, ok := rc.mutation.ReleaseDelay(); ok {
		_spec.SetField(role.FieldReleaseDelay, field.TypeFloat64, value)
		_node.ReleaseDelay = value
	}
...
// SetReleaseDelay sets the "release_delay" field.
func (u *RoleUpsert) SetReleaseDelay(v float64) *RoleUpsert {
	u.Set(role.FieldReleaseDelay, v)
	return u
}

// UpdateReleaseDelay sets the "release_delay" field to the value that was provided on create.
func (u *RoleUpsert) UpdateReleaseDelay() *RoleUpsert {
	u.SetExcluded(role.FieldReleaseDelay)
	return u
}

// AddReleaseDelay adds v to the "release_delay" field.
func (u *RoleUpsert) AddReleaseDelay(v float64) *RoleUpsert {
	u.Add(role.FieldReleaseDelay, v)
	return u
}
...
// SetReleaseDelay sets the "release_delay" field.
func (u *RoleUpsertOne) SetReleaseDelay(v float64) *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.SetReleaseDelay(v)
	})
}
...
// AddReleaseDelay adds v to the "release_delay" field.
func (u *RoleUpsertOne) AddReleaseDelay(v float64) *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.AddReleaseDelay(v)
	})
}
...
// UpdateReleaseDelay sets the "release_delay" field to the value that was provided on create.
func (u *RoleUpsertOne) UpdateReleaseDelay() *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.UpdateReleaseDelay()
	})
}
...
func (u *RoleUpsertOne) ID(ctx context.Context) (id roles.Type, err error) {
...
func (u *RoleUpsertOne) IDX(ctx context.Context) roles.Type {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetReleaseDelay sets the "release_delay" field.
func (u *RoleUpsertBulk) SetReleaseDelay(v float64) *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.SetReleaseDelay(v)
	})
}
...
// AddReleaseDelay adds v to the "release_delay" field.
func (u *RoleUpsertBulk) AddReleaseDelay(v float64) *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.AddReleaseDelay(v)
	})
}
...
// UpdateReleaseDelay sets the "release_delay" field to the value that was provided on create.
func (u *RoleUpsertBulk) UpdateReleaseDelay() *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.UpdateReleaseDelay()
	})
}
