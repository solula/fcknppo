...
func (pu *PermissionUpdate) AddRoleIDs(ids ...roles.Type) *PermissionUpdate {
...
func (pu *PermissionUpdate) RemoveRoleIDs(ids ...roles.Type) *PermissionUpdate {
...
// AddRoleIDs adds the "roles" edge to the Role entity by IDs.
func (puo *PermissionUpdateOne) AddRoleIDs(ids ...roles.Type) *PermissionUpdateOne {
...
// RemoveRoleIDs removes the "roles" edge to Role entities by IDs.
func (puo *PermissionUpdateOne) RemoveRoleIDs(ids ...roles.Type) *PermissionUpdateOne {
