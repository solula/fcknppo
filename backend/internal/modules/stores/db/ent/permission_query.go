...
func (pq *PermissionQuery) FirstID(ctx context.Context) (id permissions.Type, err error) {
	var ids []permissions.Type
...
func (pq *PermissionQuery) FirstIDX(ctx context.Context) permissions.Type {
...
func (pq *PermissionQuery) OnlyID(ctx context.Context) (id permissions.Type, err error) {
	var ids []permissions.Type
...
func (pq *PermissionQuery) OnlyIDX(ctx context.Context) permissions.Type {
...
func (pq *PermissionQuery) IDs(ctx context.Context) (ids []permissions.Type, err error) {
...
func (pq *PermissionQuery) IDsX(ctx context.Context) []permissions.Type {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *PermissionQuery) loadRoles(ctx context.Context, query *RoleQuery, nodes []*Permission, init func(*Permission), assign func(*Permission, *Role)) error {
	...
	byID := make(map[permissions.Type]*Permission)
	nids := make(map[roles.Type]map[*Permission]struct{})
	...
	qr := QuerierFunc(func(ctx context.Context, q Query) (Value, error) {
		return query.sqlAll(ctx, func(_ context.Context, spec *sqlgraph.QuerySpec) {
			...
			spec.Assign = func(columns []string, values []any) error {
				outValue := permissions.Type(values[0].(*sql.NullString).String)
				inValue := roles.Type(values[1].(*sql.NullString).String)
				if nids[inValue] == nil {
